...
- **TEMP**: `RING_FOG_BRIGHT=0` desactiva la niebla de las bandas de Ganímedes (decisión de diseño). `DEMO_LEVEL_FORCE=0` en PC y sketch (demo elige nivel al azar 1..12). **`START_LEVEL=2` (TEMP 14/9/2026: primer nivel = Ío/terremoto; REVERTIR a 1 = LUNA)**. **`DEMO_LEVEL_FIRST=7` (16/9/2026: el primer ciclo de la demo abre en Encélado/géiseres; luego re-tira al azar 1..12; 0 = sin primer nivel fijo)**. **`DEMO_WORMHOLE_FIRST=false` (16/9/2026: la demo ya NO fuerza el showcase de wormhole; cada ciclo elige nivel al azar 1..12, cualquier luna/efecto)**. **`DEMO_SPAWN_Y_MIN/MAX` (100/260)**: la nave de la demo aparece siempre a una altitud aleatoria en esa banda. `FOG_SCREEN_TOP=68` (cuadro de limpieza del HUD a la altura de MEM).
